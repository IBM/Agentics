...
# Set env vars before importing logic modules that might rely on them
os.environ["SQL_BENCHMARKS_FOLDER"] = str(BENCHMARKS_DIR) + "/" # trailing slash sometimes helps
os.environ["SQL_DB_PATH"] = str(DB_DIR)

# Ensure we can import local modules (db, utils, text2sql_logic)
sys.path.append(str(CURRENT_DIR))

from agentics.api.applications.text2sql.text2sql_logic import Text2sqlQuestion, execute_questions
