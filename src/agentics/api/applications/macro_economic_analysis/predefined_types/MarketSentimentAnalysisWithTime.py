...
class MarketSentimentAnalysisWithTime(BaseModel):
    ...
    # Use built-in list[str] instead of List[str]
    ...
    relevant_news_selection: list[str] | None = Field(
        default=None,
...
# Force rebuild to resolve forward references immediately
MarketSentimentAnalysisWithTime.model_rebuild()